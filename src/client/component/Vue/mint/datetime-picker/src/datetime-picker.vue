            ...
            <mt-popup v-model="visible" position="bottom" class="mint-datetime">
                <mt-picker
                    ...
                    <div class="popup-actions">
                      <span class="mint-datetime-action mint-datetime-cancel button"
                            v-tap="{method(){visible = false;$emit('cancel')}}">{{ cancelText }}</span>
                      <span class="mint-datetime-action mint-datetime-confirm button" v-tap="{method(){confirm()}}">{{ confirmText }}</span>
                    </div>
                </mt-picker>
            </mt-popup>
        </div>
...
import picker from '@client/component/Vue/mint/picker';
import popup from '@client/component/Vue/mint/popup';

if (process.env.NODE_ENV === 'component') {
  require('@client/component/Vue/mint/picker/style.css');
  require('@client/component/Vue/mint/popup/style.css');
}
...
export default {
  ...
  methods: {
    ...
    handleValueChange() {
      ...
      if (this.noPopUp) {
        this.$emit('dateChange', this.currentValue);
      }
    }
  },
