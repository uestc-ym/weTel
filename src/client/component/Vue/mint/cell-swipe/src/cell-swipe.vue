  ...
  <x-cell
    ...
    <div
      ...
      <a
        ...
        :key="idx"
        :style="btn.style"
        v-tap.stop="{method(){btn.handler && btn.handler(), swipeMove()}}"
...
<script>
import { once } from '@client/component/Vue/utils/dom';
import XCell from '@client/component/Vue/mint/cell';
import Clickoutside from '@client/component/Vue/utils/clickoutside';
if (process.env.NODE_ENV === 'component') {
  require('@client/component/Vue/mint/cell/style.css');
}
