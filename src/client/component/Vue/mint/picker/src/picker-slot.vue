<template>
  <div class="picker-slot" :class="classNames" :style="flexStyle">
    ...
    >
      <div
        v-tap="{method(){itemClickChange(itemValue)}}"
        :key="idx"
        class="picker-item"
        v-for="(itemValue, idx) in mutatingValues"
...
import { once, addClass, removeClass } from '@client/component/Vue/utils/dom';
import emitter from '@client/component/Vue/mixins/emitter';
import Vue from 'vue';
